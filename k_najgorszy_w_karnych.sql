-- kwerenda zliczajac nietrafione karne
SELECT t_uczestnicy.fk_id_osoba AS `kod gracza`, 
COUNT( * ) `liczba nietrafionych karnych`, t_osoby.imie, t_osoby.nazwisko, t_zespoly.nazwa_zespolu AS `nazwa zespolu gracza` 
...
WHERE t_typ_akcji.id_typu_akcji = 2 GROUP BY t_uczestnicy.fk_id_osoba, t_zespoly.nazwa_zespolu 
ORDER BY `liczba nietrafionych karnych` DESC