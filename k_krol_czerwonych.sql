-- kwerenda zliczajaca czerwone kartki
SELECT t_uczestnicy.fk_id_osoba AS `kod gracza`, 
COUNT( * ) `liczba czerwonych kartek`, t_osoby.imie, t_osoby.nazwisko, t_zespoly.nazwa_zespolu AS `nazwa zespolu gracza` 
...
WHERE t_typ_akcji.id_typu_akcji = 4 GROUP BY t_uczestnicy.fk_id_osoba, t_zespoly.nazwa_zespolu 
ORDER BY `liczba czerwonych kartek` DESC